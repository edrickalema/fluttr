    ...
    <View style={styles.container}>
      ...
      <View style={styles.demoBox}>
        ...
        <Text style={styles.demoInstructions}>
          Press the button below to simulate your date speaking. The assistant will
          provide suggestions based on what it "hears".
        </Text>
        
        <Button 
          title="Simulate Date Speaking" 
          onPress={simulateConversation} 
        />
        
        {currentConversation ? (
          <View style={styles.conversationBubble}>
            <Text style={styles.dateText}>Date says: "{currentConversation}"</Text>
          </View>
        ) : null}
      </View>
